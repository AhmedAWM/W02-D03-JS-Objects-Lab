...
const game = {
  ...
  difficulty: "Medium", // Exercise 3: Add a difficulty level to the game
  catchPokemon(pokemonObj) {
    // Exercise 10: Add catachPokemon function
  ...
  partyCount() {
    console.log(`Party Count: ${game.party.length}`);
  },
};
...
console.log(game.party); // View the party

// Exercise 5: Put 3 more starter pokemons (Total of 4)
game.party = [];
for (i = 0; i < pokemon.length; ++i) {
  if (pokemon[i].starter && game.party.length < 4) {
    game.party.push(pokemon[i]);
  }
}
...
// Exercise 6: Change "completed" to "true" if difficulty is 3 or more
// for (let i = 0; i < game.gyms.length; ++i) {
//   if (game.gyms[i].difficulty >= 3) {
//     game.gyms[i].completed = true; // Set completed to true
//   }
// }
// Commented this exercise to perform exercise 12 below

console.log(game.gyms);

// Exercise 7: Evlolve the pokemons in the party
...
// Exercise 8: Print each pokemon name in the party
console.log("Pokemon names in the party only:");
for (let i = 0; i < game.party.length; ++i) {
  console.log(game.party[i].name);
}

// Exercise 9: Print all the starter pokemons
console.log("All Starter Pokemon names:");
for (let i = 0; i < pokemon.length; ++i) {
  if (pokemon[i].starter) {
...
// Exercise 10: Line 173
// game.catchPokemon(pokemon[37]);
// console.log(game.party); // View the party
// Commented this exercise to perform exercise 11 below

// Exercise 11: Modify catcchPokemon function
...
console.log(game.party); // View the party
console.log(`Pokeballs: ${game.items[1].quantity}`); // View the pokeballs

// Exercise 12: Change "completed" to "true" if difficulty is below 6
for (let i = 0; i < game.gyms.length; ++i) {
...
// Exercise 13: Line 177
game.gameStatus(); //Call the method

// Exercise 14: Line 190
game.partyCount();

//Exercise 15: Change "completed" to "true" if difficulty is below 8
for (let i = 0; i < game.gyms.length; ++i) {
